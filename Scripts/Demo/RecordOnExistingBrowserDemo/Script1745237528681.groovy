...
WebUI.setEncryptedText(findTestObject('Object Repository/input_Password_password'), 'hUKwJTbofgPU9eVlw/CnDQ==')
...
WebUI.click(findTestObject('Object Repository/svg_Today_oxd-icon'))

WebUI.click(findTestObject('Object Repository/p_Leonardo Kikuchi'))
